            ...
            <div class="row">
              <div class="col-sm-12 col-lg-12 no-padding mb-4">
                <div class="ico-section animated fadeInLeftShort delay-250">
                  <h1 class="small-title-h">Khóa học</h1>
              ...
              <div class="big-news-grid animated fadeInRightShort delay-500">
                ...
                <template v-else>
                  ...
                  <article v-for="n in bigNews" :key=" n.href " class="news-card">
                    ...
                    <div class="cta-row">
                      <!-- dùng name nếu bạn có route name 'contact-us' -->
                      <router-link class="btn-cta" :to=" { name: 'contact-us' } ">Đăng ký ngay</router-link>
                      <!-- nếu CHƯA có route name, dùng path:
        <router-link class="btn-cta" to="/contact-us">Đăng ký ngay</router-link>
        -->
                    </div>
                  </article>
                </template>
